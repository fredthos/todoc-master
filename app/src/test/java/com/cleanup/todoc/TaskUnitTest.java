...
public class TaskUnitTest {
    ...
    private List<Project> mProjectList = Arrays.asList(
    ...
    public void test_projects() {
        ...
        assertEquals("Projet Tartampion", task1.getProject(mProjectList).getName());
        assertEquals("Projet Lucidia", task2.getProject(mProjectList).getName());
        assertEquals("Projet Circus", task3.getProject(mProjectList).getName());
        assertNull(task4.getProject(mProjectList));
    }
    ...
    public void test_project_comparator() {
        ...
        tasks.add(task2);
        tasks.add(task3);
        Collections.sort(tasks, new Task.TaskProjectSorted());
